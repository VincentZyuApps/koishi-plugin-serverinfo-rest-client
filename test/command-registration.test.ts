...
import { registerExecuteCommand } from '../src/commands/execute-command'
import { registerHealthCommand } from '../src/commands/health'
import { registerHistoryCommand } from '../src/commands/history'
import { aliasCommand, COMMAND_NAMES, commandUsage, primaryCommand } from '../src/commands/names'
import { registerOnlineCommand } from '../src/commands/online'
import { registerPlayerDataCommand } from '../src/commands/player-data'
import { registerPlayerCommand } from '../src/commands/player'
import { registerPlayersCountCommand } from '../src/commands/players-count'
import { registerPlayersNamesCommand } from '../src/commands/players-names'
import { registerPlayersCommand } from '../src/commands/players'
import { registerServerCommand } from '../src/commands/server'
